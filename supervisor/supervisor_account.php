<?php
    ...
    session_start();
    global $conn;
    global $username, $name, $address, $age, $job, $profile;

    $query = "Select supervisor.*, accounts.* from accounts INNER JOIN supervisor ON accounts.Id = supervisor.user_id where accounts.Id = '".$_SESSION['user_id']."'";
...
<div class="admin_profile">
   <div class="profile">
        <div>
            <img src="images/unknown.png" id="imgProfile">
   ...
   <div class="form-group">
        ...
        <div class="form-input">
            ...
            <button id="btn_saveChangesSupervisor">Save Changes</button>
        </div>
   </div>
</div>